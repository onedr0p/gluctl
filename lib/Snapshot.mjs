...
class Snapshot {
  constructor (...args) {
    ...
    if (!this.app) {
      throw new Error(chalk.redBright('Argument --app, -a or env APP not set'))
    }
    if (!this.namespace) {
      throw new Error(chalk.redBright('Argument --namespace, -n or env NAMESPACE not set'))
    }
    ...
    switch (this.args[0]) {
      ...
      case 'create':
        ...
        break
      default:
        throw new Error(chalk.redBright(`404: ${args[0]} arg not found`))
    }
  }
